...
public class emergencyLogin extends javax.swing.JFrame {
        ...
        switch (role) {
            case "Police" -> {
                try {
                    ...
                    String studentQuery = "SELECT * FROM universitysystem.police WHERE username = '" + username
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(emergencyLogin.class.getName()).log(java.util.logging.Level.SEVERE, null,
                    ex);

...
public class professor extends javax.swing.JFrame {
    ...
    private void btnViewStudDataActionPerformed(java.awt.event.ActionEvent evt) {// GEN-FIRST:event_btnViewStudDataActionPerformed
        ...
        try {
            ...
            String studentQuery = "SELECT * FROM universitysystem.courseregistration WHERE Subject = '"
                    + currSubjectTeach + "' and ProfessorUsername = '" + currProfUsername + "'";
    ...
    private void gradeTxtActionPerformed(java.awt.event.ActionEvent evt) {// GEN-FIRST:event_gradeTxtActionPerformed
        ...
        if (sNameTxt.getText().isEmpty() || GradeTxt.getText().isEmpty() || remarksTxt.getText().isEmpty()
                || subjectTxt.getText().isEmpty()) {
    ...
    private void subjectTableMouseClicked(java.awt.event.MouseEvent evt) {// GEN-FIRST:event_subjectTableMouseClicked
        ...
        try {
            java.sql.Connection connection = DriverManager.getConnection("jdbc:mysql://localhost:3306/universitysystem",
                    "root", "user@1234");
            java.sql.Statement statement = connection.createStatement();
            String courseQuery = "SELECT * FROM universitysystem.coursegrade WHERE studentName = '" + studentNameTxt
                    + "' AND subject = '" + subject + "'";

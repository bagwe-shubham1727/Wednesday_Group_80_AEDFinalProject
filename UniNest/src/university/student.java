...
public class student extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        subjectTxt
                .setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Web Design", "AED", "DMDD", "PSA" }));
        ...
        jLabellogocourseregistration.setIcon(
                new javax.swing.ImageIcon(getClass().getResource("/Images/Northeastern_University_Logo-White.png"))); // NOI18N
        ...
        jLabel6.setIcon(new javax.swing.ImageIcon(
                getClass().getResource("/Images/toppng.com-vignette-png-19201080-overlay-photo-1920x1080.png"))); // NOI18N
        ...
        jLabellogoactionstudent.setIcon(
                new javax.swing.ImageIcon(getClass().getResource("/Images/Logo_Northeastern-University-300x222.png"))); // NOI18N
    ...
    public class CourseReg {
        ...
        public static void CreateCourseReg(String username, String Subject, String pName, String email, int age) {
            ...
            if (!dupCourse) {
                try {
                    ...
                    // statement.executeUpdate("insert into universitysystem.login" + "(role,
                    // username, password)" + "values ('BankEmployee','"+username+"',
                    // '"+password+"')");
        ...
        public static boolean CheckCoursereg(String username, String Subject) {
            ...
            try {
                ...
                java.sql.Statement statement = connection.createStatement();
                System.out.println("connection open");
                String getQuery = "SELECT * FROM universitysystem.courseregistration WHERE Subject = '" + Subject
        ...
        public static void UpdateStudentCourse(String username, String Subject) {
            try {
                ...
                String updateQuery = "UPDATE universitysystem.students SET subjectTaken = '" + Subject
    ...
    private void submitBtnActionPerformed(java.awt.event.ActionEvent evt) {// GEN-FIRST:event_submitBtnActionPerformed
        ...
        if (txtStudUsername.getText().isEmpty() || AgeTxt.getText().isEmpty() || pnameTxt.getText().isEmpty()

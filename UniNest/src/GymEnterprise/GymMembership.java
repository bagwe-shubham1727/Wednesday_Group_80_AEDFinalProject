...
public class GymMembership extends javax.swing.JFrame {
    ...
    private void displayEmployeeDetails() {
        if (loggedInEmployee != null) {
            JOptionPane.showMessageDialog(this,
                    "Welcome, " + loggedInEmployee.getName() + " (" + loggedInEmployee.getRole() + ")");
        }
    }
        ...
        layout.setHorizontalGroup(
                layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                        .addComponent(jPanel1, javax.swing.GroupLayout.Alignment.TRAILING,
                                javax.swing.GroupLayout.DEFAULT_SIZE, 896, Short.MAX_VALUE));
    ...
    private void btnStudLogoutActionPerformed(java.awt.event.ActionEvent evt) {// GEN-FIRST:event_btnStudLogoutActionPerformed
        // TODO add your handling code here:
        int response = JOptionPane.showConfirmDialog(this, "Are you sure you want to logout?", "Logout Confirmation",

...
public class InventoryEnterpriseLogin extends javax.swing.JFrame {
        ...
        if ("Admin".equals(role) && username.equals("admin") && password.equals("admin")) {
            ...
            try {
                ...
                ResultSet resultset = statement
                        .executeQuery("SELECT * FROM universitysystem.students WHERE username = '" + username + "'");
            ...
            try {
                ...
                java.sql.Statement statement = connection.createStatement();
                ResultSet resultset = statement
                        .executeQuery("SELECT * FROM universitysystem.professors WHERE username = '" + username + "'");
            ...
            try {
                ...
                java.sql.Statement statement = connection.createStatement();
                ResultSet resultset = statement
                        .executeQuery("SELECT * FROM universitysystem.police WHERE username = '" + username + "'");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(InventoryEnterpriseLogin.class.getName())
